...
$routes->group('consultant', function($routes){

    $routes->add('list', 'Consultant::list');
    $routes->add('add', 'Consultant::add');
    $routes->add('edit/(:num)', 'Consultant::edit/$1');
    $routes->add('delete/(:num)', 'Consultant::delete/$1');
});
